...
!!! warning "Enmendado el 24-09-2026 — el filtro `code` busca por FRAGMENTO"
    ...
    `RN-MV-037` ([`requirements/mv.md`](../../../requirements/mv.md) v0.41.0), a petición del responsable del proyecto: «por si solo me sé una parte». El filtro `code` de el libro entero **deja de exigir el comprobante entero** y pasa a devolver todo el que lo **contenga**, sin distinguir mayúsculas.
