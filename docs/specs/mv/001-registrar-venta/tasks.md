...
|---|---|---|---|---|
| `T-01` | **`V54`**: `movement_types` y `payment_methods`, **creadas y sembradas en la misma migración** — `VENTA`/`VTA`, `EFECTIVO` y `TRANSFERENCIA` | — | Ninguna versión del esquema tiene la tabla de tipos vacía | **Hecha** — 04-09-2026 |
