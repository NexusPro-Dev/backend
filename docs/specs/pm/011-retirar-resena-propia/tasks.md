...
| `T-04` | **LA PRUEBA DEL SUPERADMINISTRADOR** (`ProductCommentDeleteIT`): con `products:comment`, sobre una reseña ajena | `T-03` | `CA-PM-196`: `403`, reseña viva, evento de seguridad. Y `CA-PM-195` con otro cliente. **Es la prueba que define el requerimiento**, y la que impide que la moderación llegue aflojando esta comparación | **Hecha el 14-09-2026** |
