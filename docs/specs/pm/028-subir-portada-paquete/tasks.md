...
| `T-11` | Pruebas de paquete: inexistente y retirado → `404` con el mismo cuerpo; `products:update` sin `packages:update` → `403`; inactivo, vacío y sin descripción → `200` | `T-07` | `CA-PM-358`, `CA-PM-359` | **Hecha el 16-09-2026** |
