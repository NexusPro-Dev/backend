...
| `T-10` | `api/RoleController`: añade `GET /api/v1/roles` con el permiso `roles:list` declarado sobre el método | `T-09` | Prueba de API: la consulta autorizada devuelve `200` con la envoltura de `T-02`; sin el permiso, `403` | Hecha |
