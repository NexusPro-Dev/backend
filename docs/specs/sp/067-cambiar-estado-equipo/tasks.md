...
- [x] Todas las tareas en estado `Hecha`, salvo `T-07`, que espera a `RF-SP-069` y está declarada como bloqueo 2.
- [x] Todos los criterios de aceptación con prueba automatizada en verde, salvo `CA-SP-766` mientras dure el bloqueo 2.
