...
| `CA-SP-483` | Con la marca puesta, **un endpoint cualquiera** responde `403` con `error_code` `PASSWORD_CHANGE_REQUIRED` y la ruta que resuelve el bloqueo |
