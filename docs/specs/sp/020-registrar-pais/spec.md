...
| 3 | ¿Prefijo telefónico o moneda del país? | **No ahora.** Los pedirán `USR` y el módulo de cobros cuando existan, y entonces se sabrá qué forma deben tener —un país puede tener más de un prefijo, y su moneda de curso no siempre es la de cobro—. Añadir el dato después es una migración sobre un catálogo pequeño, no una revisión de cálculos, a diferencia de los decimales de `RF-SP-019` |
