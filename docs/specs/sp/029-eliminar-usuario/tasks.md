...
| `T-07` | Revocación de sesiones **dentro** de la transacción con motivo `ACCESO_RETIRADO`, y publicación del corte de tokens de acceso **tras el commit** | `T-04` | Prueba de integración: forzando el fallo de la revocación, **no queda nada eliminado**; y el token de acceso emitido antes recibe `401` en la petición siguiente | **En curso** |
