...
| `T-02` | `V49`: `client_referrals` con sus cuatro restricciones, incluida la unicidad **parcial** del vigente | — | Dos atribuciones vigentes del mismo cliente fallan en la base, no en el caso de uso | Pendiente |
...
| `T-06` | `ClientReferralRepository` y su adaptador | `T-02` | Integración sobre la unicidad parcial | Pendiente |
