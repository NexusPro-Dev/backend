...
| 0.3.0 | 19-09-2026 | **Construida** (`CourseModuleStatusIT` (4) y `CA-AC-109` en `CourseStatusIT`, que **habilita `CA-AC-064`**). La condición mira las lecciones del módulo por `findLessonsOf` —vivas y `ACTIVAS`, con o sin contenido— y no una cuenta aparte. | Responsable técnico |
