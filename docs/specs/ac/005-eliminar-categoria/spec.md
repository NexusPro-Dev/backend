...
| 0.3.0 | 25-09-2026 | **Enmienda de `RF-AC-016`, construida** (Art. I.7): La instantánea del retiro lleva los `course_ids` reales de los cursos vivos. Probado en `CourseClassificationIT` (`CA-AC-127`). | Responsable técnico |
