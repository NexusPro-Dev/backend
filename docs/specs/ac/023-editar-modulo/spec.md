...
| 0.4.0 | 25-09-2026 | **La enmienda de §5.2.11 está construida**: el video solo se valida contra `VideoLink` —YouTube o Vimeo—, sin consultar al proveedor. | Responsable técnico |
