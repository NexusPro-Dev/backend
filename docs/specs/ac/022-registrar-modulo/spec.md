...
| 0.4.0 | 25-09-2026 | **Enmienda por decisión del responsable del proyecto** (`ac.md` §5.2.11, `RN-AC-005` reescrita): el video de presentación **solo puede ser de YouTube o de Vimeo** (`VAL-005`, con el mensaje de `RF-AC-008`). No se consulta su duración. | Responsable técnico |
