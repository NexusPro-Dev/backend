...
|---|---|---|---|---|
| `T-01` | `shared/error/ForbiddenException`: constructor con extensiones | — | El `403` de `EX-002` lleva `memberships` y `products` | Hecha |
| `T-02` | `LessonQueryRepository.findClassroomLesson(courseId, lessonId)` | — | Integración a través de `ClassroomLessonIT` | Hecha |
| `T-03` | `application/ClassroomLessonResponse` | — | El contrato declara `content` | Hecha |
| `T-04` | `GetClassroomLessonService`: tres objetos, abierta y gratuita sin puertos, `StudentKeys`, listas, `StudentAccess`, `403` con extensiones | `T-01`..`T-03`, `RF-AC-033` · `T-02`, `T-06` | `CA-AC-202` a `CA-AC-207`, `CA-AC-239` | Hecha |
...
| `T-08` | Matriz de `docs/requirements.md` y `docs/api/index.md` | `T-06` | La fila de `RF-AC-035` refleja el estado | Hecha |
