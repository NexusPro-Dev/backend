...
| `CA-AC-138` | **Desde el 25-09-2026** (`ac.md` §5.2.12): dar la primera membresía a un curso armado **no cambia `offerable`** —ya se ofrecía, a todos—: cambia **a quién se abre**, y la lista es exactamente la dada |
...
| 0.6.0 | 25-09-2026 | **Enmienda por decisión del responsable del proyecto** (`ac.md` §5.2.12, `RN-AC-015` reescrita): **un curso sin membresías ni servicios es de todos** y las llaves dejan de ser motivo de la ofrecibilidad, que queda en **cuatro** —retirado, inactivo, sin descripción, sin módulo ofrecible—. `CA-AC-138` se reescribe: la primera membresía cierra un curso que era de todos, en lugar de abrir uno que no se ofrecía. | Responsable técnico |
