...
| 0.3.0 | 25-09-2026 | **Enmienda de `RF-AC-016`, construida** (Art. I.7): `courses` trae los cursos vivos clasificados, en orden, con `offerable` decidido como en el listado de cursos —falso hasta `RF-AC-020`—; **dos** sentencias con cursos, como §15 declaraba. Probado en `CourseClassificationIT` (`CA-AC-127`). | Responsable técnico |
