...
| `VAL-006` | Video, si viene, de YouTube o de Vimeo en una forma reconocida (`RN-AC-005`) | El enlace del video debe ser un video de YouTube o de Vimeo —youtube.com, youtu.be, vimeo.com o player.vimeo.com—, sin espacios y de hasta 500 caracteres. |
...
| 0.9.0 | 25-09-2026 | **Enmienda por decisión del responsable del proyecto** (`ac.md` §5.2.11, `RN-AC-005` reescrita): el video de introducción **solo puede ser de YouTube o de Vimeo**, en una de sus formas reconocidas; cualquier otro dominio es `VAL-006` con el mensaje nuevo. El video del curso no se consulta: solo se valida. | Responsable técnico |
| 0.10.0 | 25-09-2026 | **La enmienda de §5.2.11 está construida**: el video solo se valida contra `VideoLink` —YouTube o Vimeo—, sin consultar al proveedor. | Responsable técnico |
| 0.11.0 | 25-09-2026 | **Enmienda por decisión del responsable del proyecto** (`ac.md` §5.2.12, `RN-AC-015` reescrita): **un curso sin membresías ni servicios es de todos** y las llaves dejan de ser motivo de la ofrecibilidad, que queda en **cuatro** —retirado, inactivo, sin descripción, sin módulo ofrecible—. `CourseOfferability` pierde el motivo «sin membresías ni servicios». | Responsable técnico |
