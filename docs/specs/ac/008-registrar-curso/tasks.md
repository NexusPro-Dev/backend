...
| `T-06` | **`domain/models/CourseOfferability`**: los **cinco** motivos en orden fijo —retirado, inactivo, **sin descripción**, sin membresías, sin módulo activo con lección activa con contenido— sobre entradas planas | — | Unitaria: cada motivo por separado, el orden cuando fallan varios, y el ofrecible | Pendiente |
