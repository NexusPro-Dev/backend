...
erDiagram
    ...
    teams ||--o{ team_managers : "reúne · RN-SP-052 · diseñada 21-09-2026"
    users ||--o{ team_managers : "pertenece, si es manager · RN-SP-051 · uno vigente"
    ...
    team_managers {
        ...
        uuid user_id FK "SOLO managers · RN-SP-051 · uno vigente por persona"
        timestamptz started_at "now"
...
flowchart TB
    subgraph SP["SP · Sistema Principal · 19 tablas"]
        ...
        subgraph PER["Persona"]
            ...
            C9["team_managers<br/>solo la cúspide"]
            C3["refresh_tokens"]
...
|---|---|---|
| `SP` | `permissions`, `roles`, `role_permissions`, `users`, `user_roles`, `memberships`, `user_memberships`, `currencies`, `countries`, `document_types`, `user_supervisors`, `client_sellers`, `refresh_tokens`, `password_reset_permits`, `exchange_rates`, `brokers`, `user_brokers`, `teams`, `team_managers` | **17 escritas** (`client_sellers` desde `V20`, 21-09-2026) **y dos diseñadas**: `teams` y `team_managers`, que creará `V33` con `RF-SP-063` (21-09-2026) |
