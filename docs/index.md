...
| Requerimientos con **endpoint funcionando** | 53 | [`requirements.md` §5](requirements.md#5-estado-general) |
...
| [`CM` — Comisiones](requirements/cm.md) | En desarrollo | 5 | 0 | 5 | 0 |
| **Total** | — | **54** | **49** | **53** | **0** |
...
| Pruebas unitarias en verde | 220 | `./mvnw clean verify` |
| Pruebas de integración en verde | 746 | `./mvnw clean verify` |
...
| [Requerimientos y trazabilidad](requirements.md) | 0.74.0 | Borrador |
