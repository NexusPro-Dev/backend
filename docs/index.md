...
|---|---|---|
| Migraciones Flyway | 30 | `src/main/resources/db/migration` |
| Pruebas unitarias en verde | 154 | `./mvnw clean verify` |
| Pruebas de integración en verde | 602 | `./mvnw clean verify` |
