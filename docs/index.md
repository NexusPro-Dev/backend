...
| Requerimientos con **endpoint funcionando** | 47 | [`requirements.md` §5](requirements.md#5-estado-general) |
...
| [`PM` — Productos y Mercadeo](requirements/pm.md) | En desarrollo | 7 | 7 | 5 | 0 |
| **Total** | — | **49** | **49** | **47** | **0** |
...
| Pruebas unitarias en verde | 209 | `./mvnw clean verify` |
| Pruebas de integración en verde | 714 | `./mvnw clean verify` |
...
| [Requerimientos y trazabilidad](requirements.md) | 0.73.0 | Borrador |
