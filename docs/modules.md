...
| Equipos | Cómo se organiza la cúspide de la fuerza comercial: cada equipo reúne managers, uno vigente por manager y con historial. Agrupa, no manda | `teams`, `team_managers` |
