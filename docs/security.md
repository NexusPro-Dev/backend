...
| Solicitud de recuperación | 10 | 3 | 1 hora |
...
En el refresco el margen es enorme porque una interfaz con varias pestañas refresca en ráfaga; lo que se corta es el bucle. Y la de solicitud de recuperación es la más estricta por lo que ya dice la regla de arriba: tres a la hora bastan para quien de verdad olvidó su contraseña, y cada repetición es **otro correo a una persona real**. Su confirmación es más holgada porque no provoca ningún envío: deja margen a quien se equivoca copiando el código y no deja sitio a una búsqueda.
