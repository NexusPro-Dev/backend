...
| El cliente: **estado, vendedor vigente y nivel de membresía** | Si puede comprar, **de qué vendedor cuelga** —que es a quién se atribuirá la venta— y de qué nivel parte | `RF-MV-001`, `RF-MV-002` |
