...
|---|---|---|
| **2 — Devengo y liquidación** | Al confirmar una venta, **devengar para toda la cadena**; y al cerrar un periodo, pagar lo devengado | El modelo está **decidido** (`RN-MV-019` a `RN-MV-023`) y solo falta escribirlo. Se deja para la etapa 2 porque necesita movimientos reales contra los que probarse: un devengo sobre una venta inventada no prueba nada |
