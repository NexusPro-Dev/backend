...
| Permiso requerido | — (**Público**) |
| Prioridad | **Crítica** |
| Reglas aplicables | `RN-SP-016`, `RN-SP-018`, `RN-SP-026`, `RN-SP-027`, `RN-SP-028`, `RN-SP-034` a `RN-SP-038`, `RN-SP-040`, `RN-SP-041`, `RN-SP-042` |
| Depende de | `RF-SP-024`, `RF-SP-032`, `RF-SP-052`, `RF-PM-001` |
