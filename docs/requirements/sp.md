...
| Permiso requerido | — (**Público**) |
| Prioridad | **Crítica** |
| Reglas aplicables | `RN-SP-016`, `RN-SP-018`, `RN-SP-026`, `RN-SP-027`, `RN-SP-028` |
