...
| Externo | Consume | **YouTube Data API v3** y **oEmbed de Vimeo** (`RN-AC-005`, `RN-AC-017`, desde el 25-09-2026): la duración de un video al registrar o corregir una lección `VIDEO`. Con plazo corto, a su dirección fija, y la clave de YouTube por variable de entorno |
