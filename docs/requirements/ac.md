...
| `RN-AC-017` | **La duración se mide en segundos enteros** | Al registrar y al corregir una lección | Un entero **mayor que cero**, **obligatorio en los dos tipos**: en `VIDEO` es lo que dura; en `TEXTO`, el tiempo estimado de lectura que administración declara. Sirve para que el alumno sepa cuánto le espera y para sumar la duración del módulo y del curso **en cada lectura**, sin guardarla — **también en segundos**, y el frontend la formatea. **En segundos desde el 25-09-2026** (§5.2.10); hasta entonces, en minutos | Media |
